...
slave: $(SLAVE_OBJECTS)
	$(CC) $(SLAVE_OBJECTS) Binaries/test_sysvmq.o Binaries/sysvmq.o -o Binaries/$(EXEC_SLAVE) $(LINKER_OPTIONS)

view: $(VIEW_OBJECTS)
	$(CC) $(VIEW_OBJECTS) Binaries/test_sysvmq.o Binaries/sysvmq.o -o Binaries/$(EXEC_VIEW) $(LINKER_OPTIONS)
